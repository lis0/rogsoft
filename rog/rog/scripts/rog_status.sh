...
GT-AC5300)
	...
	interface_2g_temperature=`wl -i ${interface_2g} phy_tempsense | awk '{print $1}'`
	interface_5g1_temperature=`wl -i ${interface_5g1} phy_tempsense | awk '{print $1}'`
	interface_5g2_temperature=`wl -i ${interface_5g2} phy_tempsense | awk '{print $1}'`
