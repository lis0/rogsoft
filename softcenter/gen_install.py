...
def work_parent():
    ignore_paths = frozenset(["maintain_files", "softcenter", "appledns", "ddnspod", "speedtest", "dualwan", "kcptun", "koolnet", "kuainiao", "shadowvpn", "shellinabox", "tunnel",  "phddns", "ssid", "shadowsocks" ])
