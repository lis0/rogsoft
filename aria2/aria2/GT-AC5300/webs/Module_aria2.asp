  ...
  <head>
    ...
    <style type="text/css">
      ...
      .active {
      	background: #2f3a3e;
      	background: #91071f;
      	background: linear-gradient(to bottom, #a5b56f  0%, #677835 100%); /* W3C */
...
function buildswitch() {
	$("#aria2_enable").click(
		...
		if (E('aria2_enable').checked) {
			db_aria2_["aria2_enable"] = 1;
			E('aria2-webui').style.display = "";
			E('yaaw').style.display = "";
...
function save() {
	...
	for (var i = 0; i < params_input.length; i++) {
		if (E(params_input[i]).value) {
			db_aria2_[params_input[i]] = E(params_input[i]).value;
		}
	}
	if (!E("aria2_rpc_secret").value){
		db_aria2_["aria2_rpc_secret"] = randomString(32);
	}
	// check for 0 and 1
	for (var i = 0; i < params_check1.length; i++) {
		db_aria2_[params_check1[i]] = E(params_check1[i]).checked ? '1' : '0';
	}
	// check for true and false
	for (var i = 0; i < params_check2.length; i++) {
		db_aria2_[params_check2[i]] = E(params_check2[i]).checked ? 'true' : 'false';
	}
	//base64
	for (var i = 0; i < params_base64.length; i++) {
	...
	var postData = {"id": id, "method": "aria2_config.sh", "params": [1], "fields": db_aria2_ };
	$.ajax({
		url: "/_api/",
		cache: false,
		type: "POST",
...
function load_default_value() {
	...
	var id = parseInt(Math.random() * 100000000);
	var postData = {"id": id, "method": "aria2_config.sh", "params": [2], "fields": dbus };
	$.ajax({
		url: "/_api/",
		cache: false,
		type: "POST",
...
function generate_glutton_link() {
	...
	E("link4.1").href = "http://aria2.me/glutton/" + "?s=" + link_glutton;
}
             ...
             <tr id="glutton">
                ...
                <td>
                   <div style="padding-top:5px;">
                      <a id="link4.1" href="http://aria2.me/glutton/" target="_blank"><i><u>http://aria2.me/glutton/</u></i></a>
                      <span><a style="font-size: 12px;margin-left: 20px;" href="http://koolshare.cn/thread-40938-1-1.html" target="_blank"><i><u>关于glutton</u></i></a>
                   </div>
                 </td>
             </tr>
             <tr id="yaaw">
              ...
              <td>
               <div style="padding-top:5px;">
                <a href="http://aria2.me/yaaw/" target="_blank"><i><u>http://aria2.me/yaaw/</u></i></a>
               </div>
              </td>
             </tr>
             <tr id="aria2-webui">
              ...
              <td>
               <div style="padding-top:5px;">
                <a href="http://aria2.me/webui-aria2/" target="_blank"><i><u>http://aria2.me/webui-aria2/</u></i></a>
               </div>
              </td>
             </tr>
            </table>
            ...
            <table id="aria2_base_table" style="margin:-1px 0px 0px 0px;display: none;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
                          ...
                          <tr>
                            ...
                            <td>
                             ...
                             <small></br>手动输入或者双击输入框选择路径，如果没有定义，将使用第一个USB设备的根目录.</small>
                            </td>
                          </tr>
                          <tr>
                            <td style="width:25%;">
                          ...
                          <tr>
                            ...
                            <td>
                              <textarea rows=6 style="width:99%; font-family:'Lucida Console'; font-size:12px;background:transparent;border:1px solid #91071f;color:#FFFFFF;" name="aria2_custom" id="aria2_custom" title="">ca-certificate=false
check-certificate=false</textarea>
                        ...
                        <table id="aria2_bt_table" style="margin:-1px 0px 0px 0px;display: none;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
                          ...
                          <tr>
                            ...
                            <td>
                              <textarea rows=6 style="width:99%; font-family:'Lucida Console'; font-size:12px;background:transparent;border:1px solid #91071f;color:#FFFFFF;" name="aria2_bt_tracker" id="aria2_bt_tracker"></textarea>
                            </td>
                          </tr>
                          <tr>
                            <td style="width:25%;">
                        ...
                        <table id="aria2_help" style="margin:-1px 0px 0px 0px;display: none;" width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
                          <tr>
	                        <td>
		                        <ul>
		                       	 <li>注意：本插件目前仅适用于koolshare RT-AC86U改版固件和GT-AC5300官改固件！</li>
		                       	 <li>注意：未挂载磁盘时，开启aria2会默认使用路由器/tmp空间作为默认下载地址！</li>
