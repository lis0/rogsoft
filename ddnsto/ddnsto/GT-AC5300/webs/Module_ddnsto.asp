                                    ...
                                    <td bgcolor="#4D595D" colspan="3" valign="top" style="border-radius: 8px"><div>&nbsp;</div>
                                        ...
                                        <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
                                            ...
                                            <tr id="rule_update_switch">
                                                <th>管理/帮助</th>
                                                <td>
                                                    <a type="button" class="rog_btn" style="cursor:pointer" href="https://ddns.to" target="_blank">https://www.ddns.to</a>
                                                    <a type="button" class="rog_btn" style="cursor:pointer" onclick="openShutManager(this,'NoteBox',false,'关闭使用说明','ddnsto使用说明') " href="javascript:void(0);">ddnsto使用说明</a>
                                                </td>
                                            </tr>
                                        </table>
