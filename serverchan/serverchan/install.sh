...
if [ "$MODEL" == "GT-AC5300" ];then
	cp -f /tmp/serverchan/GT-AC5300/serverchan /koolshare/
	cp -f /tmp/serverchan/GT-AC5300/webs/Module_serverchan.asp /koolshare/webs/
else
	cp -f /tmp/serverchan/serverchan /koolshare/
	cp -f /tmp/serverchan/webs/Module_serverchan.asp /koolshare/webs/
fi
...
dbus set softcenter_module_serverchan_version="0.1.13"
